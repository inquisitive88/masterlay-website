...
$sidebarItems = [
    ...
    ['label' => 'Shop Products', 'url' => '/shop/admin/products', 'page' => 'shop-products', 'icon' => 'M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z'],
    ['label' => 'Shop Orders', 'url' => '/shop/admin/orders', 'page' => 'shop-orders', 'icon' => 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4'],
    'divider',
    ...
    ['label' => 'Quote Pricing', 'url' => '/admin/quote-pricing', 'page' => 'quote-pricing', 'icon' => 'M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z'],
    'divider',
