...
<!-- Floating Quote Button (homepage only) -->
<a href="/quote" id="floatingQuoteBtn" style="position:fixed;bottom:1.5rem;right:1.5rem;z-index:9999;" class="btn btn-primary shadow-xl shadow-primary/25 pulse-glow flex items-center gap-2 no-underline">
