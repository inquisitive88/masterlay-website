            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                ...
                <div class="relative" data-animate="slide-right">
                    <div class="rounded-3xl overflow-hidden">
                        <img src="../images/services/basement-renovation.jpg" alt="Finished basement renovation" class="w-full aspect-[4/5] object-cover" loading="lazy">
                    </div>
        ...
        <div class="container-wide">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                ...
                <div class="relative order-2 lg:order-1" data-animate="slide-left">
                    <div class="rounded-3xl overflow-hidden">
                        <img src="../images/general/modern-basement-living.jpg" alt="Modern basement living space" class="w-full aspect-[4/3] object-cover" loading="lazy">
                    </div>
                </div>
        ...
        <div class="container-wide">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6" data-animate="stagger-up">
                <div class="rounded-2xl overflow-hidden">
                    <img src="../images/general/finished-basement.jpg" alt="Finished basement living room" class="w-full aspect-[4/3] object-cover hover:scale-105 transition-transform duration-500" loading="lazy">
                </div>
                <div class="rounded-2xl overflow-hidden">
                    <img src="../images/general/modern-basement-living.jpg" alt="Basement home theatre" class="w-full aspect-[4/3] object-cover hover:scale-105 transition-transform duration-500" loading="lazy">
                </div>
                <div class="rounded-2xl overflow-hidden">
                    <img src="../images/general/vinyl-plank-living.jpg" alt="Modern basement bar area" class="w-full aspect-[4/3] object-cover hover:scale-105 transition-transform duration-500" loading="lazy">
                </div>
            </div>
        </div>
    </section>
