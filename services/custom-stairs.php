            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                ...
                <div class="relative" data-animate="slide-right">
                    <div class="rounded-3xl overflow-hidden">
                        <img src="<?= IMG ?>/services/custom-stairs.jpg" alt="Custom staircase design" class="w-full aspect-[4/5] object-cover" loading="lazy">
                    </div>
        ...
        <div class="container-wide">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6" data-animate="stagger-up">
                <div class="rounded-2xl overflow-hidden">
                    <img src="<?= IMG ?>/general/modern-staircase.jpg" alt="Modern custom staircase" class="w-full aspect-[4/3] object-cover hover:scale-105 transition-transform duration-500" loading="lazy">
                </div>
                <div class="rounded-2xl overflow-hidden">
                    <img src="<?= IMG ?>/general/wood-metal-stairs.jpg" alt="Wood and metal staircase" class="w-full aspect-[4/3] object-cover hover:scale-105 transition-transform duration-500" loading="lazy">
                </div>
                <div class="rounded-2xl overflow-hidden">
                    <img src="<?= IMG ?>/general/traditional-hardwood-stairs.jpg" alt="Traditional hardwood staircase" class="w-full aspect-[4/3] object-cover hover:scale-105 transition-transform duration-500" loading="lazy">
                </div>
            </div>
        </div>
    </section>
